<?php
//BN lsapp.php contains the custom functions referenced throughout
...
$tmp = array();
// loop through everything and add the CourseName to
// the temp array
foreach($courses as $line) {
	$tmp[] = $line[2];
}
// Sort the whole kit and kaboodle by CourseName
array_multisort($tmp, SORT_ASC, $courses);

$draftmode = $_GET['draftmode'] ?? 0;

//BN Is this part related to the Course Filter feature?
//BN When a filter is applied, I see ?courseids= in the URL
