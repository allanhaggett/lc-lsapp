...
<?php if(!empty($coursesfiltered)): ?>
	<h1><span class="badge bg-primary"><?php echo count($coursesfiltered) ?></span> courses</h1>
<?php else: ?>
...
<div class="mb-3">
	<a class="badge bg-dark-subtle text-primary-emphasis" href="./courses.php">All Alphabetically</a> 
	<a class="badge bg-dark-subtle text-primary-emphasis" href="./courses.php?sort=dateadded">All Recent</a>
...
<div class="mb-2">
	...
	<a href="courses.php?category=<?php echo urlencode($category[1]) ?>" 
		class="badge bg-dark-subtle text-primary-emphasis">
		<?= $category[1] ?>
	</a> 
	<?php endforeach ?>
	</details>
