...
<h3>Pending Class Changes <span class="badge badge-dark"><?= count($classchanges) ?></span></h3>
<!--Ben Testing Sort requests-->
...
<nav class="nav justify-content-left mt-1">
	<a href="admin-bentesting.php" class="nav-link">Date Added</a>
	<a href="admin-bentesting.php?sort=startdate" class="nav-link">Start Date</a>
</nav>
...
<h3>Pending Course Changes <span class="badge badge-dark"><?= count($coursechanges) ?></span></h3>
<ul class="list-group">
<?php $coursechanges = getPendingCourseChanges() ?>
...
?>
<h3 class="mt-3">New Class Service Requests <span class="badge badge-dark"><?= count($reqs) ?></span></h3>
