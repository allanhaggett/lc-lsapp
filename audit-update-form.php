...
<h1><?= $audit->Status ?> - Auditing: <?= $audit->ResourceName ?? 'Something is wrong. Contact an admin.' ?></h1>
...
<form method="post" action="audit-update.php" class="bg-light-subtle p-2 mb-5 rounded-3">
...
<label for="LSAppCourseid">Course in LSApp</label> 
<a href="/lsapp/course.php?courseid=<?= $audit->LSAppCourseid ?>">View LSApp course page</a><br>

<select id="LSAppCourseid" name="LSAppCourseid" class="form-control">
...
<?php else: ?>
	<div class="my-3">
	<input type="hidden" id="LSAppCourseid" name="LSAppCourseid" class="form-control" value="<?= $audit->LSAppCourseid ?>">
	<a href="/lsapp/course.php?courseid=<?= $audit->LSAppCourseid ?>">View LSApp course page</a><br>
</div>
	<?php endif ?>
...
<input type="text" name="Duration" id="Duration" class="form-control" value="<?= $audit->Duration ?? '' ?>" required>
...
<textarea name="AlignOrganizationalGoals" id="AlignOrganizationalGoals" class="form-control mb-3" rows="5"><?= $audit->AlignOrganizationalGoals ?? ''  ?></textarea>
...
<div class="form-check d-inline-block mt-3 mr-3">
  <input type="checkbox" name="BCPSPrincipleLearnerCentre[]" id="BCPSPrincipleLearnerCentreYes" value="Yes" class="form-check-input" <?php if(in_array('Yes',$audit->BCPSPrincipleLearnerCentre)) echo 'checked' ?>>
  <label class="form-check-label" for="BCPSPrincipleLearnerCentreYes">Yes</label>
</div>
<div class="form-check d-inline-block">
  <input type="checkbox" name="BCPSPrincipleLearnerCentre[]" id="BCPSPrincipleLearnerCentreNo" value="No" class="form-check-input" <?php if(in_array('No',$audit->BCPSPrincipleLearnerCentre)) echo 'checked' ?>>
...
<div class="form-check d-inline-block mt-3 mr-3">
  <input type="checkbox" name="BCPSPrincipleAlignedBusinessPriority[]" id="BCPSPrincipleAlignedBusinessPriorityYes" value="Yes"value="Yes" value="Yes" class="form-check-input" <?php if(in_array('Yes',$audit->BCPSPrincipleAlignedBusinessPriority)) echo 'checked' ?>>
  <label class="form-check-label" for="BCPSPrincipleAlignedBusinessPriorityYes">Yes</label>
</div>
<div class="form-check d-inline-block">
  <input type="checkbox" name="BCPSPrincipleAlignedBusinessPriority[]" id="BCPSPrincipleAlignedBusinessPriorityNo" value="No" class="form-check-input" <?php if(in_array('No',$audit->BCPSPrincipleAlignedBusinessPriority)) echo 'checked' ?>>
...
<div class="form-check d-inline-block mt-3 mr-3">
  <input type="checkbox" name="BCPSPrincipleAvailableJIT[]" id="BCPSPrincipleAvailableJITYes" value="Yes" class="form-check-input" <?php if(in_array('Yes',$audit->BCPSPrincipleAvailableJIT)) echo 'checked' ?>>
  <label class="form-check-label" for="BCPSPrincipleAvailableJITYes">Yes</label>
</div>
<div class="form-check d-inline-block">
  <input type="checkbox" name="BCPSPrincipleAvailableJIT[]" id="BCPSPrincipleAvailableJITNo" value="No" class="form-check-input" <?php if(in_array('No',$audit->BCPSPrincipleAvailableJIT)) echo 'checked' ?>>
...
<div class="form-check d-inline-block mt-3 mr-3">
  <input type="checkbox" name="BCPSPrincipleEmpowerGrowth[]" id="BCPSPrincipleEmpowerGrowthYes" value="Yes" class="form-check-input" <?php if(in_array('Yes',$audit->BCPSPrincipleEmpowerGrowth)) echo 'checked' ?>>
  <label class="form-check-label" for="BCPSPrincipleEmpowerGrowthYes">Yes</label>
</div>
<div class="form-check d-inline-block">
  <input type="checkbox" name="BCPSPrincipleEmpowerGrowth[]" id="BCPSPrincipleEmpowerGrowthNo" value="No" class="form-check-input" <?php if(in_array('No',$audit->BCPSPrincipleEmpowerGrowth)) echo 'checked' ?>>
...
<div class="form-check d-inline-block mt-3 mr-3">
  <input type="checkbox" name="BCPSPrinciplePromoteConnectness[]" id="BCPSPrinciplePromoteConnectnessYes" value="Yes" class="form-check-input" <?php if(in_array('Yes',$audit->BCPSPrinciplePromoteConnectness)) echo 'checked' ?>>
  <label class="form-check-label" for="BCPSPrinciplePromoteConnectnessYes">Yes</label>
</div>
<div class="form-check d-inline-block">
  <input type="checkbox" name="BCPSPrinciplePromoteConnectness[]" id="BCPSPrinciplePromoteConnectnessNo" value="No" class="form-check-input" <?php if(in_array('No',$audit->BCPSPrinciplePromoteConnectness)) echo 'checked' ?>>
...
<div class="form-check d-inline-block mt-3 mr-3">
 <input type="checkbox" name="BCPSPrincipleAnchorEstablishedContent[]" id="BCPSPrincipleAnchorEstablishedContentYes" value="Yes" class="form-check-input" <?php if(in_array('Yes',$audit->BCPSPrincipleAnchorEstablishedContent)) echo 'checked' ?>>
  <label class="form-check-label" for="BCPSPrincipleAnchorEstablishedContentYes">Yes</label>
</div>
<div class="form-check d-inline-block">
  <input type="checkbox" name="BCPSPrincipleAnchorEstablishedContent[]" id="BCPSPrincipleAnchorEstablishedContentNo" value="No" class="form-check-input" <?php if(in_array('No',$audit->BCPSPrincipleAnchorEstablishedContent)) echo 'checked' ?>>
...
<div class="form-check d-inline-block mt-3 mr-3">
  <input type="checkbox" name="BCPSPrincipleEncourageReflection[]" id="BCPSPrincipleEncourageReflectionYes" value="Yes" class="form-check-input" <?php if(in_array('Yes',$audit->BCPSPrincipleEncourageReflection)) echo 'checked' ?>>
  <label class="form-check-label" for="BCPSPrincipleEncourageReflectionYes">Yes</label>
</div>
<div class="form-check d-inline-block">
  <input type="checkbox" name="BCPSPrincipleEncourageReflection[]" id="BCPSPrincipleEncourageReflectionNo" value="No" class="form-check-input" <?php if(in_array('No',$audit->BCPSPrincipleEncourageReflection)) echo 'checked' ?>>
...
<div class="row justify-content-md-center bg-light-subtle fixed-bottom">
<div class="col-md-6">
