...
<div class="btn-group">
<?php if(isAdmin()): ?>
<a href="course-update.php?courseid=<?= $courseid ?>" class="btn btn-danger">Edit</a>
<?php endif ?>
...
<a href="class-request.php?courseid=<?= $deets[0] ?>" class="btn btn-dark my-3">New Date Request</a>
