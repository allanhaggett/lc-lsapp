...
<div id="upcoming-classes">
	...
	<div class="text-center"><small>Going back to January 1st 2019 | <a href="classes-past-export.php">Export</a></small></div>
	...
	<tr class="<?= $statrow ?>">
		...
		<td class="facilitator"><a href="person.php?idir=<?= h($row[14]) ?>"><?= h($row[14]) ?></a></td>
		<!--<td><?= h($row[47]) ?></td>-->
		<td class="enrolled">
		...
		<td class="attendance">
		<?php if($row[39] != 'Yes'): ?>
		<span class="badge badge-danger">No</a>
		<?php else: ?>
		<span class="badge badge-success">Yes</a>
		<?php endif ?>
		</td>
	</tr>
<?php endforeach ?>
