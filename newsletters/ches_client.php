...
class CHESClient {
    ...
    public function __construct($clientId, $clientSecret, $tokenEndpoint) {
...
/**
 * Load CHES credentials from file
 */
function loadCHESCredentials($credsFile = 'ches-creds.txt') {
    $creds = [];
    
    if (!file_exists($credsFile)) {
        throw new Exception("Credentials file not found: $credsFile");
    }
    ...
    return [
        ...
        'token_endpoint' => $creds['token_endpoint'] ?? null
    ];
}
?>